...
{
	assert (block_type () == rai::block_type::send || block_type () == rai::block_type::receive ||
	      block_type () == rai::block_type::open || block_type () == rai::block_type::change ||
	      block_type () == rai::block_type::send_v2
	);
	write_header (stream_a);
